...
<div class="container45">
    <?php include '../../assets/includes/sidebar-trabajadores.php'; ?>
            ...
            <div class="search-section">
                <form method="GET" class="search-form">
                    ...
                    <?php if (!empty($busqueda)): ?>
                        <a href="?" class="clear-btn">Limpiar búsqueda</a>
                    <?php endif; ?>
                </form>
            </div>
                        ...
                        <table class="clients-table">
                            ...
                            <tbody>
                                <?php foreach ($clientes as $cliente): ?>
                                    ...
                                    ?>
                                    <tr class="client-row" onclick="showClientDetails(<?php echo $cliente['cliente_id']; ?>)">
...
function showClientDetails(clientId) {
    ...
    fetch('functions.php', {
        ...
        body: `accion=obtener_detalles_cliente&cliente_id=${clientId}&csrf_token=${encodeURIComponent(csrfToken)}`
    })
