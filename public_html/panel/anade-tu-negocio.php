...
<body>
    <div class="container">
        <h1>¡Vaya!</h1>
        <div class="message">
            <span class="bold">No tienes ningún negocio.</span>
            <span class="small">Añade tu negocio para poder empezar a usar nuestra plataforma.</span>
        </div>
        <div class="btn-group">
            <a href="https://buscounservicio.es/panel/anadir-negocio">Añadir Negocio</a>
        </div>
    </div>
</body>
</html>