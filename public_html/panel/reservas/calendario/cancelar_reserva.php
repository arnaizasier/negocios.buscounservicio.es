...
$sql_reserva = "SELECT id_negocio, id_cliente FROM reservas WHERE id_reserva = :id_reserva";
...
$id_negocio_reserva = $reserva_data['id_negocio'];

$sql_negocio = "SELECT 1 FROM negocios WHERE negocio_id = :id_negocio AND usuario_id = :usuario_id";
$stmt_negocio = $pdo2->prepare($sql_negocio);
$stmt_negocio->bindParam(':id_negocio', $id_negocio_reserva, PDO::PARAM_INT);
$stmt_negocio->bindParam(':usuario_id', $user_id, PDO::PARAM_INT);
