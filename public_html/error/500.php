...
<main>
    ...
    <strong class="error-message">Error interno del servidor</strong>
    <p class="error-description">Ha ocurrido un problema en el servidor. Por favor, inténtalo de nuevo más tarde.</p>
