...
<main>
    ...
    <strong class="error-message">Acceso prohibido</strong>
    <p class="error-description">No tienes permisos para acceder a este recurso, incluso después de autenticarte.</p>
