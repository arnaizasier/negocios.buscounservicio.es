...
<main>
    ...
    <strong class="error-message">No implementado</strong>
    <p class="error-description">El servidor no reconoce el método de solicitud o carece de la capacidad para completarla.</p>
